...
public class App 
{
    ...
    private static void readConfig() {
    	...
    	try {
    		appConfig.load(App.class.getResourceAsStream("/application.properties"));
    ...
    //Extracts the year out of the parameter and creates the directory structure if it doesn't exist
    private static String buildDirectoryStructure(Date date) {
	Calendar cal = Calendar.getInstance();
	cal.setTime(date);
	String outDir = outputDirectory + "/" + String.valueOf(cal.get(Calendar.YEAR)) + "/";
